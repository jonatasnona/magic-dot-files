        ...
        " FileType {
            ...
            " handlebars, mustache {
                NeoBundleLazy 'mustache/vim-mustache-handlebars', {
                    \   'autoload' : {
                    \       'filetypes': ['handlebars', 'hbs', 'mustache', 'mst'],
                    \       },
                    \   }
            " }
...
" Abreviations {
    ab nonarev Reviewed-by: Jonatas Pedraza <jonatas.nona@gmail.com>
    ab nonasig Signed-off-by: Jonatas Pedraza <jonatas.nona@gmail.com>
" }
...
" Plugins {
    ...
    " SnipMate {
        ...
        let g:snips_author = 'Jonatas Pedraza <jonatas.nona@gmail.com>'
    " }
